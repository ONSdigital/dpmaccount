...
**In brief:**
Contributors with write access to this repository should create and make changes on a feature branch. Contributors without write access should fork this repository to their own GitHub account and make changes on a new branch.
...
For reproducibility, we also set a seed. Seeds are stored in the results object and so, if required, must be set at this stage.
```{r estimate_account}
